...
const TEAM: Record<string, [string, string, string]> = {
  ...
  LAC: ["#0080C6", "#FFFFFF", "#FFC20E"], LAR: ["#003594", "#FFD100", "#FFD100"],
...
function TeamTag({ team }: { team: string }) {
  ...
  return (
    <span className="tdb-tag" style={{ background: bg, color: fg, borderBottomColor: trim }}>
      {team}
    </span>
  );
}
